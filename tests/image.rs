...
fn compute_write_storage_fragment_read_sampled() {
    ...
    let image_barrier = vk_sync::ImageBarrier {
        ...
        next_accesses: vec![vk_sync::AccessType::FragmentShaderReadSampledImageOrUniformTexelBuffer],
    ...
    assert_eq!(barrier.new_layout, ash::vk::ImageLayout::ShaderReadOnlyOptimal);
}
...
fn graphics_write_color_compute_read_sampled() {
    ...
    assert_eq!(src_mask, ash::vk::PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT);
    assert_eq!(dst_mask, ash::vk::PIPELINE_STAGE_COMPUTE_SHADER_BIT);
    assert_eq!(barrier.src_access_mask, ash::vk::ACCESS_COLOR_ATTACHMENT_WRITE_BIT);
    assert_eq!(barrier.dst_access_mask, ash::vk::ACCESS_SHADER_READ_BIT);
    assert_eq!(barrier.old_layout, ash::vk::ImageLayout::ColorAttachmentOptimal);
    assert_eq!(barrier.new_layout, ash::vk::ImageLayout::ShaderReadOnlyOptimal);
}
...
fn graphics_write_depth_compute_read_sampled() {
    ...
    assert_eq!(src_mask, ash::vk::PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT | ash::vk::PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT);
    assert_eq!(dst_mask, ash::vk::PIPELINE_STAGE_COMPUTE_SHADER_BIT);
    assert_eq!(barrier.src_access_mask, ash::vk::ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT);
    assert_eq!(barrier.dst_access_mask, ash::vk::ACCESS_SHADER_READ_BIT);
    assert_eq!(barrier.old_layout, ash::vk::ImageLayout::DepthStencilAttachmentOptimal);
    assert_eq!(barrier.new_layout, ash::vk::ImageLayout::ShaderReadOnlyOptimal);
}
...
fn graphics_write_depth_fragment_read_attachment() {
    ...
    assert_eq!(dst_mask, ash::vk::PIPELINE_STAGE_FRAGMENT_SHADER_BIT);
    assert_eq!(barrier.src_access_mask, ash::vk::ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT);
    assert_eq!(barrier.dst_access_mask, ash::vk::ACCESS_INPUT_ATTACHMENT_READ_BIT);
    assert_eq!(barrier.old_layout, ash::vk::ImageLayout::DepthStencilAttachmentOptimal);
    assert_eq!(barrier.new_layout, ash::vk::ImageLayout::DepthStencilReadOnlyOptimal);
}
...
fn graphics_read_sampled_graphics_write_color() {
    ...
    let image_barrier = vk_sync::ImageBarrier {
        previous_accesses: vec![vk_sync::AccessType::FragmentShaderReadSampledImageOrUniformTexelBuffer],
    ...
    assert_eq!(dst_mask, ash::vk::PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT);
    assert_eq!(barrier.src_access_mask, ash::vk::AccessFlags::empty());
    assert_eq!(barrier.dst_access_mask, ash::vk::AccessFlags::empty());
    assert_eq!(barrier.old_layout, ash::vk::ImageLayout::ShaderReadOnlyOptimal);
    assert_eq!(barrier.new_layout, ash::vk::ImageLayout::ColorAttachmentOptimal);
}
